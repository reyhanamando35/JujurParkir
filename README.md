...
| Nama | Peran | GitHub |
|------|-------|--------|
| **[Nama Lengkap 1]** | Project Lead & Full Stack Developer |
...
## 🎯 Tentang Proyek
### Latar Belakang
[Jelaskan konteks permasalahan yang ingin diselesaikan. Gunakan data atau fakta untuk
memperkuat argumen. Contoh: "Berdasarkan survei X, 70% pengguna mengalami kesulitan
dalam..."]
### Solusi yang Ditawarkan
[Jelaskan bagaimana aplikasi ini menyelesaikan masalah tersebut dengan pendekatan yang
unik atau inovatif]
### Tujuan Proyek
